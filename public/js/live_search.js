...
/* WEBPACK VAR INJECTION */(function($) {// Live search /cities/ page
$(document).ready(function () {
  function fetch_data(page, query) {
    var is_for_company = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    var _url = "/taxi/search_city?page=" + page + "&query=" + query;
  ...
  $('.city-input').keyup(function () {
    var query = $(this).val(); // К инпуту добавлен класс for_company в том случае, если это страница городов с компаниями
...
/***/ 5:
/*!*******************************************!*\
  !*** multi ./resources/js/live_search.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
